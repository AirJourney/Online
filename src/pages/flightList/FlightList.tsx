...
const FlightList = () => {
  ...
  const onSearchClick = async (searchFormData?: TFlightSearch) => {
    ...
    getFlightListResult({ ...searchFormData, currency: headData.currency ,locale: headData.locale });
  };
  ...
  const getStepSelectCityMultiName = () => {
    if (flightListData.length === 0) return;
    const flight = flightListData[0].flightGroupInfoList[selectIndex];
    return flight.departMultCityName + " - " + flight.arriveMultCityName;
  };
  ...
  const getFlightListResult = async (searchFormData?: any) => {
    ...
    // }, 2000);
    try{
      // await post("/website/shopping", searchFormData || newSubmitData);
                  ...
                  {selectIndex > 0 && (
                    <div className="select-card-wrapper">
                      ...
                      <div className="center">
                        ...
                        <p className="depart">
                          {displayLocaleTime(selectFlight?.departDateTimeFormat,EmomentFormatType.RECOMMEND)}
                        </p>
                        <p className="time">
                          <span className="time">
                            {displayLocaleTime(selectFlight?.departDateTimeFormat,EmomentFormatType.TIME)}
                          </span>
                          <span className="timeSplit">-</span>
                          <span className="time">
                            {displayLocaleTime(selectFlight?.arriveDateTimeFormat,EmomentFormatType.TIME)}
                          </span>
                        </p>
                      ...
                      <div className="list-wrapper">
                        <div className="gKzZXe">
                          <div className="iRdFSI">
                            <img
                              src={
                                "https://www.skywingtrip.com/static/image/home/search_no_result.png"
                              }
                              alt=""
                            />
                          </div>
                    ...
                    >
                      <div className="airline-info">
                          ...
                          <div className="f-info-flight-no">
                            {
                              flightDetail.flightSegments.map(v=><p key={v.airlineInfo.code + v.flightNo}>{v.airlineInfo.code + v.flightNo}</p>)
                            }
                          </div>
                        </div>
                      <div className="left-box"
                        ...
                        <div
                          className="f-info-time"
                        >
                          <div className="time-left-box">
                            <span className="time">
                              {displayLocaleTime(flightDetail.departDateTimeFormat,EmomentFormatType.TIME)}
                            </span>
                            <span className="code">
                          ...
                          <div className="time-right-box">
                            <span className="time">
                              {displayLocaleTime(flightDetail.arriveDateTimeFormat,EmomentFormatType.TIME)}
                            </span>
                            <span className="code">
                              {
