...
export const PriceTable = (props: { priceData?: PolicyDetailInfo, passengerList: TPassenger[] }) => {
  ...
  return (
    <div className="price-detail-info">
        ...
        {checkPrice(
            priceData?.adultPrice,
            passengerList[0].count,
            t("Adult")
        )}
        {checkPrice(
            priceData?.childPrice,
        ...
        <span className="total">
          <span className="curreny">{currency}</span>{priceData?.totalPrice}
        </span>
        </div>
