...
import { message, Tabs, Space, Typography, Button } from "antd";
      ...
      >
        ...
        >
          ...
          <div style = {{ marginBottom: 10 }}>
            ...
            >
              {t('Already a SkyWingTrip.com member ? Sign In >')}
            </a>
        </div>
            
        </ProForm>
        <div style={{ marginTop: 50, fontSize: 10, color: 'gray', marginLeft: 10}}>
          {t('loginStatement')}
        </div>
      </PageContainer>
      {/* <Text onClick={}></Text> */}
