import { ECurrencySymbolType, ECurrencyType } from "@features/header";
...
export const getCityImageByCityCode = (companyCode: string, type?: number) => {
  return `http://skywingtrip.com/static/image/city/${companyCode.toUpperCase()}_${type? '750_500' : '960_210' }.jpg`
}
